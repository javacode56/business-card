...
div.div1,.div2{
  ...
  overflow: scroll;
    ...
    <body onload=" setData1();">
        ...
        <input type="color" id="html5colorpicker" onchange="clickColor(0, -1, -1, 5)" value="#ff0000" ><button onclick="color()">Set color</button>
      </div>   
   ...
   <div ><b> <p id="colorhexDIV" hidden="hidden"></p></b></div>
    ...
    <div id="colorhslDIV" hidden="hidden"></div>    
              ...
              <input type="file" value="Choose Logo" onchange="previewImage1(this);"/>
      ...
      <p><button onclick="setBorder1()">Set Border</button></p>
           ...
           <input type="text10" id="text10"/> 
           
       <p><button onclick="ad()"><<</button> <button onclick="text10()">click</button> <button onclick="ad1()">>></button></p>
...
<div style="width:570px; height:350px; position: absolute;  top:20%; left:25%;  " >
           <canvas id="canvas"   width="560" height="300">
            ...
            <script src="scripts/up3.js"></script>
             ...
             function save()
                           {
                               ...
                               var canvasImage1 = document.getElementById('canvas').toDataURL('image/png',1.0);
    ...
    <div style="width:20px; height:10px; border: darkblue;  position:absolute; top:75%; left:25%; ">
            <form action="save.jsp" id="form1" method="post" >
             ...
             <input type="text" id="val2" name="ImageData" hidden="hidden" />
